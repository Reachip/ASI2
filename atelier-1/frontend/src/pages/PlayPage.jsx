...
const opponentCards = [
    ...
    { id: 6, name: 'Lion', img_src: 'https://img.freepik.com/premium-photo/male-lion-roars-ai-generated_767640-31.jpg', family_name: 'Animals', description: 'The king of the jungle', hp: 24, energy: 24, defense: 10, attack: 20 }
];

const playerCards = [
    { id: 7, name: 'Shark', img_src: 'https://img.freepik.com/premium-photo/shark-attack-clear-ocean-waters_863013-102252.jpg', family_name: 'Animals', description: 'A deadly shark', hp: 21, energy: 21, defense: 9, attack: 17 },
    { id: 8, name: 'Griffon', img_src: 'https://img.freepik.com/premium-photo/illustration-ofdesign-image-gryphon-sky-with-majes_756405-36588.jpg', family_name: 'Mythical', description: 'A mighty griffon', hp: 23, energy: 23, defense: 9, attack: 19 },
    ...
    { id: 10, name: 'Wolf', img_src: 'https://img.freepik.com/premium-photo/african-wolf-about-attacking-images-generative-ai_880278-533.jpg', family_name: 'Animals', description: 'A fierce wolf', hp: 19, energy: 19, defense: 8, attack: 16 },
    ...
    { id: 12, name: 'Elephant', img_src: 'https://img.freepik.com/premium-photo/big-elephant-attack-forest-3d-design_909213-5431.jpg', family_name: 'Animals', description: 'A giant elephant', hp: 30, energy: 30, defense: 15, attack: 25 }
];
